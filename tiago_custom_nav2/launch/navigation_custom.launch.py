...
CONFIG_PATH_ROOT = os.path.join(get_package_share_directory('tiago_custom_nav2'), 'config')
...
def declare_actions(
    ...
    bt_navigator = Node(
        ...
        output='screen',
        emulate_tty=True,
        parameters=os.path.join(CONFIG_PATH_ROOT, 'bt_navigator.yaml'),
    ...
    controller_server = Node(
        ...
        output='screen',
        emulate_tty=True,
        parameters=os.path.join(CONFIG_PATH_ROOT, 'controller_server.yaml'),
    ...
    planner_server = Node(
        ...
        output='screen',
        emulate_tty=True,
        parameters=os.path.join(CONFIG_PATH_ROOT, 'planner_server.yaml'),
    ...
    behavior_server = Node(
        ...
        output='screen',
        emulate_tty=True,
        parameters=os.path.join(CONFIG_PATH_ROOT, 'behavior_server.yaml'),
    ...
    waypoint_follower = Node(
        ...
        output='screen',
        emulate_tty=True,
        parameters=os.path.join(CONFIG_PATH_ROOT, 'waypoint_follower.yaml'),
    ...
    lifecycle_manager = Node(
        ...
        output='screen',
        emulate_tty=True,
        parameters=os.path.join(CONFIG_PATH_ROOT, 'lifecycle_manager.yaml'),
